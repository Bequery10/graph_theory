...
class Main{                             
    public static void main(String args[]){                  boolean display=false; // if eddEdges function used, prints the adjacents
        int size=20; //size of the DiGraph
...
private static void addEdges(DiGraph graph, int edges,boolean display){
    Random random=new Random();
    int size= graph.V();
    for(int i=0;i<size;i++) {

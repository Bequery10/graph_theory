                ...
                if (Math.abs(p1.x - p2.x) == 2) {
                    ...
                    while ((Math.abs(smallerP.y - y) > 0 || Math.abs(smallerP.x - x) > 0)) {
                        ...
                        if (count % 2 == 0 && Math.abs(smallerP.y - y) > 0) {
                            ...
                            if (smallerP.y >= 0
                                    && (arr[smallerP.x][smallerP.y] == 0 || arr[smallerP.x][smallerP.y] == 65535
                                            || arr[smallerP.x][smallerP.y] == 65534)
                                    && arr[smallerP.x][smallerP.y] != 65533) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            for (int j = 0; j < arr[i].length; j++) {
                ...
                if (arr[i][j] == '\0') {
                    ...
                    if (((int) arr[i][j] + "").length() > 1)
                        nExternal += ((int) arr[i][j] + "").length() - 1;
                }
            }
            System.out.println();
        }
